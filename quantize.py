...
def main():
    ...
    parser.add_argument('--quant_method', default='linear', help='linear|minmax|log|tanh|dynamic')
    ...
    assert args.quant_method in ['linear', 'minmax', 'log', 'tanh','dynamic']
    print("=================FLAGS==================")
    ...
    if args.param_bits < 32:
        ...
        for k, v in state_dict.items():
           ...
           #     v_quant = quant.dynamic_quantize(v,bits=bits)
            else:
